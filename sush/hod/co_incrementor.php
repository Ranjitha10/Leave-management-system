        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="page-header-breadcrumb">
                    <div class="page-heading hidden-xs"><h1 class="page-title" style="color:blue">HOD</h1></div>
                ...
                <div style="height: 770px" class="row" align="middle">
                    <div class="col-lg-12">
                                       ...
                                       <div>
                 <div class="panel panel-white" align="center">
                  <div class="panel-heading" style="color:blue"><h2>Increment CO Balance</h2></div>
				...
				<div>
				 <input id="saveForm" class="btn btn-blue btn-lg" type="submit" name="submit" value="Increment" />
				</div>
				</div>
				</div>
				</div>
