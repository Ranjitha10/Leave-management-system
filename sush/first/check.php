...
//$_SESSION["u_pass"]=$_POST['pass'];
			...
			$_SESSION["usn2"]=$_POST['usn'];
					...
					<br><br><tr><td><tr><td></tr></td></tr></tr>
					<tr><td><font color="white" size=5.8>Internal:</font></td><td><select id="text" name="test"/>
...
while($row1=$result1->fetch_array(MYSQLI_ASSOC))
{
	if(!(strcmp($row1["usn"],$usn)))
	{
		...
		{
			if( strcmp($usn,$row2["usn"])==0 && $row1["sem"]==$row2["sem"] && $row2["filename"]==$test )
			{
