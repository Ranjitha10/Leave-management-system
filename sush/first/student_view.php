...
<div id="outer">
    ...
    <ul>
		...
		<ul>
				...
				<li><a href="stu_view_hss.php" target="iframe_a">HSS DETAILS</a></li><li>
				<a href="stu_view_absence.php" target="iframe_a">ABSENCE DETAILS</a></li>
            </ul>
			</li>
        <li><a href="#">INSERT</a>
		<ul>
                <li><a href="student_reg.php" target="iframe_a">GENERAL DETAILS</a></li>
		<li><a href="stu_insert_fee.php" target="iframe_a">FEE DETAILS</a></li>
        ...
        <li><a href="#">UPDATE</a>
            <ul>
                ...
                <li><a href="stu_update_fee.php" target="iframe_a">ADMISSION DETAILS</a></li>
                 <li><a href="image.html" target="iframe_a">Upload </a></li>
            </ul>
        </li>
