...
<center>
      <form method="post" action="" >
					...
					<tr><td><font color="white" size=5.8>Name:</font></td><td><input type="text" name="name" ></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="white" size=5.8>DOB:</font></td><td><input type="int" name="dob" ></td></tr>
								<tr><td><br></td></tr>
					...
					<input type="radio" name="sex" value="Female"><font color="White" size=4>Female</font></input>
								...
								<tr><td><br></td></tr>
					<tr><td><font color="white" size=5.8>Year of Admission:</font></td><td><input type="text" name="yoa"></td></tr>
					...
					<tr><td><font color="white" size=5.8>Mother's Email ID:</font></td><td><input type="text" name="m_id"/></td></tr>	
							<tr><td><br></td></tr>
					<tr><td><font color="white" size=5.8>Batch no:</font></td><td><input type="text" name="b_no" ></td></tr>	
							<tr><td><br></td></tr>
							<tr><td><br></td></tr>
...
$sql = "insert into counsellor.student1 values('$name',$dob,'$sex',$yoa,'$usn',$batch,'$e_id',$ph,'$address','$mode',$rank,'$f_name','$f_id',$f_no,'$m_name','$m_id',$m_no)";
