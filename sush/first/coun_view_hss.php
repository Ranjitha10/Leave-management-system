...
<center>
	...
	<br>
	<br>
	<tr><td><b><font size=6>HSS details  </font></b></td>
	<?php
	...
	if(!(strcmp($row1["usn"],$usn)))
	{
		while($row2=$result2->fetch_array(MYSQLI_ASSOC))
		{
            ...
            <tr>
                ...
                <td width="10%" height="10%"><?php echo $row2["event"]; ?></td>
                <td width="10%" height="10%"><?php echo $row2["start"]; ?></td>
                <td width="10%" height="10%"><?php echo $row2["end"]; ?></td>
                <td width="10%" height="10%"><?php echo $row2["category"]; ?></td>
            </tr>
