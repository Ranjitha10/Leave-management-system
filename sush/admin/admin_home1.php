...
<body class="animated fadeIn"  style="color:blue">
    ...
    <div >
        ...
        <div id="wrapper">
            ...
            <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
                <div class="sidebar-collapse menu-scroll" stlye="bg-color:white" style="color:blue" >
				...
				<li class="clock">
					<div align="center"><img src="rvce.jpg" align="middle"  width="150" height="150" class="img-responsive img-circle" alt="Leave Management System" /></div>
                        ...
                        <li class="sidebar-heading" stlye="bgcolor:white" style="color:blue" ><h4>Main Menu</h4></li>
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
									<h1 class="animated rollIn"> <font color="blue">Welcome <?php
