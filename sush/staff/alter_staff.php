        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
				...
				<div class="panel panel-white">
				 <div class="panel-heading block-heading" align="center" style="color:blue"><h3>Extra Classes</h3></div>
				<div class="portlet">
...
if(!mysql_select_db("leave_man",$con)){return false;}
		...
		<div>
			  <input onClick="isChecked()" class="btn btn-blue" type="submit" name="submit" value="save" />
			</div>
		</div>
		</div>
		</div>
