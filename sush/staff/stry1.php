...
<body  class="animated fadeInDown">
    ...
    <div >
        ...
        <div id="wrapper">
            ...
            <!--END TOPBAR-->
            <!--BEGIN SIDEBAR MENU-->
            <nav id="topbar" role="navigation" class="navbar-default navbar-static-top">
                <div class="sidebar-collapse menu-scroll">
                    <ul id="side-menu" class="nav">
                       <div align="left"><img src="rvce.jpg" align="middle"  width="100" height="100" class="img-responsive img-circle" alt="Leave Management System" /></div>
