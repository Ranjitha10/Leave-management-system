...
<body class="animated fadeIn ">
    ...
    <div >
        ...
        <div id="wrapper">
                ...
                <!--BEGIN CONTENT-->
				 <div class="page-content">
				     ...
				     <div class="panel panel-white">
                                            <div class="panel-heading" align="center" style="color:blue"><h2>Leave Account</h2></div>
                                            <div class="panel-body pan">
											<div class="form-body pal">
                                    
							
						<h3 class="animated rollIn"><font color="blue">	<?php
				$con=@mysql_connect("localhost","root","");
			if(!$con){return false;}
			if(!mysql_select_db("leave_man",$con)){return false;}
			$usr=$_SESSION["username"];
			...
			$cla=$row["availcl"];
			$val=($cla/($clb+$cla))*100;
			echo $val;?>%;" class="progress-bar progress-bar-blue"></div>
                                </div>
								</div>
<div>	
